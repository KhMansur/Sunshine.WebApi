...
namespace Sunshine.Data.Migrations
{
    ...
    [Migration("20230521184751_CorrectModelsPayments")]
    partial class CorrectModelsPayments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sunshine.Data.Models.ApiUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1f1b5450-df19-4a7a-a70f-7bc386732151",
                            EmailConfirmed = false,
                            FirstName = "Mansur",
                            LastName = "Xamrayev",
                            LockoutEnabled = false,
                            NormalizedUserName = "KHMANSUR",
                            PasswordHash = "AQAAAAIAAYagAAAAEIbAUbiFs1F999X+4YsvHXRZJpCodE8I4DN/DqMZInySj8Zu5i5oKmpa597Apm2BmA==",
            ...
            modelBuilder.Entity("Sunshine.Data.Models.Attendence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sunshine.Data.Models.AttendencePerDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sunshine.Data.Models.AttendencePerDay", b =>
                {
                    b.HasOne("Sunshine.Data.Models.Attendence", "Attendence")
                        .WithMany("AttendencePerDay")
